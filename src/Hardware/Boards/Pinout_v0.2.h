...
namespace Board
{
    ...
    {   
        ...
        // Ecran (SPI1)
        inline SPIClassRP2040* const LCD_SPI = &SPI1;
        ...
        // ADS1120 (SPI0)
        inline SPIClassRP2040* const ADC_SPI = &SPI;
    ...
    namespace Mcp23017
    {
        ...
        inline constexpr Mcp23017Pin SW_4_WIRE   = Mcp23017Pin::GPA1;
        inline constexpr Mcp23017Pin RREF16k5   = Mcp23017Pin::GPA7;
        ...
        inline constexpr Mcp23017Pin RREF1k65   = Mcp23017Pin::GPA2;
