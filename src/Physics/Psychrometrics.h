...
namespace Physics
{
    ...
    public:
         ...
         */
        static double_t relativeHumidity(
            double_t dryBulb,
            double_t wetBulb,
            double_t pressure);
         ...
         */
        static double_t saturationVaporPressure(
            double_t temperature);

        /**
         * @brief Pression de vapeur réelle (Pa)
         */
        static double_t vaporPressure(
            double_t dryBulb,
            double_t wetBulb,
            double_t pressure);
         ...
         */
        static double_t absoluteHumidity(
            double_t temperature,
            double_t humidity);

        /**
         * @brief Humidité relative (%) par méthode psychrométrique historique
         */
        static double_t getRH(
            double_t dryBulb,
            double_t wetBulb,
            double_t pressure);
